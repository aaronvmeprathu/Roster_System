...
const createShiftTeams14 = (employees, monthStart, prevEveningTeamIds = null) => {
  ...
  // Morning Team: 5 members (exactly 2 female seniors, 1 male senior, 2 juniors)
  ...
  teams.morning.push(...takeFromPool(remainingJuniors, 2, (employee) => !workedNightShiftLastMonth(employee)));
  if (teams.morning.filter(e => e.level === "junior").length < 2) {
    const needed = 2 - teams.morning.filter(e => e.level === "junior").length;
